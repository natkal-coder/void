...
export const localProviderNames = ['ollama', 'vLLM', 'lmStudio', 'llamaServer', 'liteRT'] satisfies ProviderName[] // all local names
				...
				: providerName === 'vLLM' ? defaultProviderSettings.vLLM.endpoint
					: providerName === 'openAICompatible' ? 'https://my-website.com/v1'
						: providerName === 'llamaServer' ? defaultProviderSettings.llamaServer.endpoint
							: providerName === 'liteRT' ? defaultProviderSettings.liteRT.endpoint
...
export const defaultSettingsOfProvider: SettingsOfProvider = {
	...
	liteRT: {
		...defaultCustomSettings,
		...defaultProviderSettings.liteRT,
		...modelInfoOfDefaultModelNames(defaultModelsOfProvider.liteRT),
		_didFillInProviderSettings: undefined,
	},
